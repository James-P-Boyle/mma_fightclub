...
@section('content')
  ...
  <x-hero-header>
    <h1 class="text-4xl font-bold lg:text-5xl">MMA FIGHTCLUB</h1>
    <h2 class="-mt-4 text-2xl font-bold lg:text-5xl">BAD HERSFELD</h2>
    <x-divider />
    <h3 class="text-2xl lg:text-4xl">Your health is not just an asset, it's your greatest investment</h3>
