<section class="flex flex-col justify-center gap-8 px-4">
  ...
  <div class="flex flex-col gap-4 md:flex-row justify-center items-center md:max-w-[12000px] mx-auto">
    ...
    >
        <span class="inline-block p-2 rounded-lg ">
            ...
            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 14l9-5-9-5-9 5 9 5zm0 0l6.16-3.422a12.083 12.083 0 01.665 6.479A11.952 11.952 0 0012 20.055a11.952 11.952 0 00-6.824-2.998 12.078 12.078 0 01.665-6.479L12 14zm-4 6v-7.5l4-2.222"></path></svg>
        </span>
    ...
    >
        ...
        <p class="text-lg font-bold md:text-xl group-hover:text-ci-red">Kids Brazillian Jiu-Jitsu</p>
    </a>
