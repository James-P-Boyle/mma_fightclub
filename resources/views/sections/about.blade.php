<section class="text-white bg-black bg-opacity-90">
  ...
  <div class="grid md:grid-cols-[2fr_1fr]">
    ...
    <div class="flex flex-col items-center justify-center gap-6 px-4 py-16 md:px-8">
      ...
      <div class="space-x-2">
        <a href="{{route('about')}}" class="px-4 py-2 text-2xl font-medium bg-white rounded shadow text-ci-red hover:scale-105">About Us</a>
        <a href="{{route('contact')}}" class="px-4 py-2 text-2xl font-medium text-white rounded shadow bg-ci-red hover:scale-105">Contact</a>
      </div>
